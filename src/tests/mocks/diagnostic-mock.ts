...
export class DiagnosticMock extends Diagnostic {
   ...
   * @returns {Promise<boolean>}
   */
  isCameraRollAuthorized(): Promise<any> {
    return new Promise((resolve, reject) => {
      resolve(true);
    });
  }
   ...
   * @returns {Promise<boolean>}
   */
  isRemoteNotificationsEnabled(): Promise<any> {
    return new Promise((resolve, reject) => {
      resolve(true);
    });
  }
   ...
   * @returns {Promise<boolean>}
   */
  isRemindersAuthorized(): Promise<any> {
    return new Promise((resolve, reject) => {
      resolve(true);
    });
  }
   ...
   * @returns {Promise<boolean>}
   */
  isBackgroundRefreshAuthorized(): Promise<any> {
    return new Promise((resolve, reject) => {
      resolve(true);
    });
  }
   ...
   * @return {Promise<boolean>}
   */
  isMotionRequestOutcomeAvailable(): Promise<any> {
    return new Promise((resolve, reject) => {
      resolve(true);
    });
  }
